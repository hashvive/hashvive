#!/usr/bin/env python3
# Copyright (c) 2020-present The Hashvive developers
...
class P2PFeelerReceiver(P2PInterface):
    def on_version(self, message):
        # The hashvived node closes feeler connections as soon as a version
...
class P2PAddConnections(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # hashvived behaves properly when a version is sent unexpectedly (but
        # tolerably) early.
        #
        # This checks that hashvived sends its own version prior to processing
