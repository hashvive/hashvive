...
# Copyright 2016-2017 The Hashvive developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Test framework for hashvive utils.
...
def main():
    ...
    bctester(os.path.join(env_conf["SRCDIR"], "test", "util", "data"), "hashvive-util-test.json", env_conf)
...
def bctest(testDir, testObj, buildenv):
    ...
    if testObj["exec"] == "./hashvive-util":
        execprog = os.getenv("HASHVIVEUTIL", default=execprog)
    elif testObj["exec"] == "./hashvive-tx":
        execprog = os.getenv("HASHVIVETX", default=execprog)
    ...
    if "error_txt" in testObj:
        ...
        # That stderr is empty if no errors are expected. However, hashvive-tx
