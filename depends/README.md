...
**When configuring Hashvive, CMake by default will ignore the depends output.** In
...
created. To use it during configuring Hashvive:
...
variables will be set when generating the Hashvive buildsystem. In this case, `-DENABLE_WALLET=OFF`.
