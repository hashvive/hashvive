...
This document provides guidelines for internationalization of the Hashvive software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n active connection to hashvive network</numerusform>
            <numerusform>%n active connections to hashvive network</numerusform>
        </translation>
    </message>
...
This can be checked by building the `translate` target with `cmake` ([instructions](translation_process.md)), then verifying that `hashvive_en.ts` remains unchanged.
