...
This guide describes how to build hashvived, command-line utilities, and GUI on NetBSD.
...
It is not necessary to build wallet functionality to run hashvived or the GUI.

###### Descriptor Wallet Support

`sqlite3` is required to enable support for [descriptor wallets](https://github.com/hashvive/hashvive/blob/master/doc/descriptors.md).
...
There are many ways to configure Hashvive. Here is an example that
