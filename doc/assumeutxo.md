...
Assumeutxo is a feature that allows fast bootstrapping of a validating hashvived
instance.
...
```
$ hashvive-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ hashvive-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```
