...
```sh
cmake --build build --target hashvived hashvive-cli
cmake --build build --target hashvive-qt
cmake --build build --target bench_hashvive
```
...
[remote "upstream-pull"]
        ...
        url = git@github.com:hashvive/hashvive.git
```
