...
previously Hashvive would listen for incoming Tor connections on `127.0.0.1:8334`.
...
127.0.0.1:5556`, or configure hashvived with `-bind=127.0.0.1:8334=onion` to get the previous behavior.
(#31223)
