Hashvive version 0.9.2.1 is now available from:

https://hashvive.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 HRLV to 0.01 HRLV
...
- Fix "Start hashvive on system login"
