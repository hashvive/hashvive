hashvive version 0.5.4 is now available for download at:
http://sourceforge.net/projects/hashvive/files/hashvive/hashvive-0.5.4/
...
http://gitorious.org/hashvive/hashvived-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix hashvive-Qt notifications under Growl 1.3.
Increase required age of hashvive-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitcoin properly when installing hashvive-Qt over it. (Windows)
