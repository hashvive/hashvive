Hashvive version 0.10.4 is now available from:

<https://hashvive.org/bin/hashvive-core-0.10.4/>
...
- #6953 `43c2789` Split hashvive-tx into its own package
- #6953 `dfe0d4d` Include hashvive-tx binary on Debian/Ubuntu
