Hashvive version _0.14.3_ is now available from:

<https://hashvive.org/bin/hashvive-core-0.14.3/>
...
Hashvive versions 0.14.0 up to 0.16.2. It is recommended to upgrade any of
...
- #10451 `3612219` contrib/init/hashvived.openrcconf: Don't disable wallet by default (Luke Dashjr)
