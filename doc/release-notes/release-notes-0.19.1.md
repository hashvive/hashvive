...
Hashvive version 0.19.1 is now available from:

<https://hashvive.org/bin/hashvive-core-0.19.1/>
...
From Hashvive 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Hashvive is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Hashvive does not yet change appearance when
...
- #17488 fix "hashvived already running" warnings on macOS (fanquake)
