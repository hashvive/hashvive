Hashvive version 0.16.1 is now available from:

<https://hashvive.org/bin/hashvive-core-0.16.1/>
...
- #12843 `df38b13` Test starting hashvived with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure hashvived processes are cleaned up when tests end (sdaftuar)
