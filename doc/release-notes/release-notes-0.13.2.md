Hashvive version 0.13.2 is now available from:

<https://hashvive.org/bin/hashvive-core-0.13.2/>
...
- #8908 `4a974b2` Update hashvive-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow hashvive-tx to create v2 transactions (btcdrak)
