Hashvive version 27.0 is now available from:

<https://hashvive.org/bin/hashvive-core-27.0/>
...
## libhashviveconsensus

- libhashviveconsensus is deprecated and will be removed for v28. This library has
  ...
  In the future, libhashvivekernel will provide a much more useful API that is
...
- A C++20 capable compiler is now required to build Hashvive. (#28349)
...
- Various fixes to prevent issues where subsequent instances of Hashvive would
