Hashvive version 0.11.1 is now available from:

<https://hashvive.org/bin/hashvive-core-0.11.1/>
...
(see https://github.com/hashvive/hashvive/pull/6795).
...
one was randomly violated by all deployed hashvive software prior to
...
Hashvive has produced compatible signatures since a28fb70e in
...
[1] On the Malleability of hashvive Transactions
Marcin Andrychowicz, Stefan Dziembowski, Daniel Malinowski, Łukasz Mazurek
http://fc15.ifca.ai/preproceedings/hashvive/paper_9.pdf
...
(see https://github.com/hashvive/hashvive/pull/6793, as well as the 0.11
...
- #6571 `100ac4e` libhashviveconsensus: avoid a crash in multi-threaded environments
