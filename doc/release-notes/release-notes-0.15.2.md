Hashvive version _0.15.2_ is now available from:

<https://hashvive.org/bin/hashvive-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in hashvive-tx (TheBlueMatt)
