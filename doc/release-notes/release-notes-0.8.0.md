hashvive-Qt version 0.8.0 is now available from:
http://sourceforge.net/projects/hashvive/files/hashvive/hashvive-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the hashvive
...
## New/changed settings (command-line or hashvive.conf file)
