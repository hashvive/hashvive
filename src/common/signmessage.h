...
#ifndef HASHVIVE_COMMON_SIGNMESSAGE_H
#define HASHVIVE_COMMON_SIGNMESSAGE_H
 ...
 * @param[in] address Signer's hashvive address, it must refer to a public key.
...
#endif // HASHVIVE_COMMON_SIGNMESSAGE_H
