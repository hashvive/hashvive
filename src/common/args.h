...
#ifndef HASHVIVE_COMMON_ARGS_H
#define HASHVIVE_COMMON_ARGS_H
...
extern const char * const HASHVIVE_CONF_FILENAME;
extern const char * const HASHVIVE_SETTINGS_FILENAME;
