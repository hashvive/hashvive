...
#ifndef HASHVIVE_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
#define HASHVIVE_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
...
#endif // HASHVIVE_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
