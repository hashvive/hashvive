...
#ifndef HASHVIVE_ARITH_UINT256_H
#define HASHVIVE_ARITH_UINT256_H
...
public:
     ...
     *
     * hashvive only uses this "compact" format for encoding difficulty
...
#endif // HASHVIVE_ARITH_UINT256_H
