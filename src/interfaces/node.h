...
#ifndef HASHVIVE_INTERFACES_NODE_H
#define HASHVIVE_INTERFACES_NODE_H
...
//! Top-level interface for a hashvive node (hashvived process).
class Node
{
public:
    ...
    //! Return setting value from <datadir>/settings.json or hashvive.conf.
...
#endif // HASHVIVE_INTERFACES_NODE_H
