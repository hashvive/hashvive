...
#ifndef HASHVIVE_INTERFACES_INIT_H
#define HASHVIVE_INTERFACES_INIT_H
...
//! (hashvive-gui, hashvive-node, hashvive-wallet, hashvived, hashvive-qt) and each
...
#endif // HASHVIVE_INTERFACES_INIT_H
