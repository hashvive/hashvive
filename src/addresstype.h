...
#ifndef HASHVIVE_ADDRESSTYPE_H
#define HASHVIVE_ADDRESSTYPE_H
 ...
 *  A CTxDestination is the internal data type encoded in a hashvive address
 */
...
/**
 * Generate a hashvive scriptPubKey for the given CTxDestination. Returns a P2PKH
 * script for a CKeyID destination, a P2SH script for a CScriptID, and an empty
 * script for CNoDestination.
 */
CScript GetScriptForDestination(const CTxDestination& dest);

#endif // HASHVIVE_ADDRESSTYPE_H
