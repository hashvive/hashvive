...
#ifndef HASHVIVE_NODE_CONNECTION_TYPES_H
#define HASHVIVE_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/hashvive-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on hashvive’s Peer-to-Peer Network")
...
#endif // HASHVIVE_NODE_CONNECTION_TYPES_H
