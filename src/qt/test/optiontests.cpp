...
{
    // Test regression https://github.com/hashvive/hashvive/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/hashvive-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/hashvive-core/gui/pull/568.
    // With fListen=false in ~/.config/hashvive/hashvive-Qt.conf and all else left as default,
    // hashvive-qt should set both -listen and -listenonion to false and start successfully.
