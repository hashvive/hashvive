...
#ifndef HASHVIVE_QT_HASHVIVEGUI_H
#define HASHVIVE_QT_HASHVIVEGUI_H
...
/**
  hashvive GUI main class. This class represents the main window of the hashvive UI. It communicates with both the client and
...
public:
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a hashvive wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    /** Load Partially Signed hashvive Transaction from file or clipboard */
...
#endif // HASHVIVE_QT_HASHVIVEGUI_H
