...
#ifndef HASHVIVE_QT_HASHVIVEUNITS_H
#define HASHVIVE_QT_HASHVIVEUNITS_H
...
/** hashvive unit definitions. Encapsulates parsing and formatting
...
public:
    ...
    /** hashvive units.
      @note Source: https://en.hashvive.it/wiki/Units . Please add only sensible ones
     */
    enum class Unit {
        HRLV,
        mHRLV,
...
#endif // HASHVIVE_QT_HASHVIVEUNITS_H
