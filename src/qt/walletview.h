...
#ifndef HASHVIVE_QT_WALLETVIEW_H
#define HASHVIVE_QT_WALLETVIEW_H
...
private:
    ...
    //!
    //! The wallet model represents a hashvive wallet, and offers access to
...
#endif // HASHVIVE_QT_WALLETVIEW_H
