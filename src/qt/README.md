This directory contains the source code for the Hashvive graphical user interface (GUI). It uses the [Qt](https://www1.qt.io/developers/) cross-platform framework.
