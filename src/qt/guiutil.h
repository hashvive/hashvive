...
#ifndef HASHVIVE_QT_GUIUTIL_H
#define HASHVIVE_QT_GUIUTIL_H
...
/** Utility functions used by the hashvive Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "hashvive:" URI into recipient object, return true on successful parsing
