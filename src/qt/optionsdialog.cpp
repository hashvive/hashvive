      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->hashviveAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->hashviveAtStartup);
    ...
    ui->hashviveAtStartup->setToolTip(ui->hashviveAtStartup->toolTip().arg(CLIENT_NAME));
    ui->hashviveAtStartup->setText(ui->hashviveAtStartup->text().arg(CLIENT_NAME));
...
{
    /* Main */
    mapper->addMapping(ui->hashviveAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSHRLVontrols);
