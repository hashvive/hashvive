...
#ifndef HASHVIVE_QT_OPTIONSMODEL_H
#define HASHVIVE_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for hashvive client.
...
public:
    ...
    BitcoinUnit getDisplayUnit() const { return m_display_hashvive_unit; }
    QString getThirdPartyTxUrls() const { return strThirdPartyTxUrls; }
    QFont getFontForMoney() const;
    bool getCoinControlFeatures() const { return fCoinControlFeatures; }
    bool getSubFeeFromAmount() const { return m_sub_fee_from_amount; }
    bool getEnablePSHRLVontrols() const { return m_enable_psbt_controls; }
...
private:
    ...
    QString language;
    BitcoinUnit m_display_hashvive_unit;
...
#endif // HASHVIVE_QT_OPTIONSMODEL_H
