...
#ifndef HASHVIVE_RPC_PROTOCOL_H
#define HASHVIVE_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in hashvived
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< hashvive is not connected
