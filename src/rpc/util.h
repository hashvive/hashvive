...
#ifndef HASHVIVE_RPC_UTIL_H
#define HASHVIVE_RPC_UTIL_H
...
/**
 * Parse a json number or string, denoting HRLV/kvB, into a CFeeRate (sat/kvB).
 * Reject negative values or rates larger than 1HRLV/kvB.
 */
