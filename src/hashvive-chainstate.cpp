...
//
// The hashvive-chainstate executable serves to surface the dependencies required
// by a program wishing to use Hashvive's consensus engine as it is right
// now.
//
// DEVELOPER NOTE: Since this is a "demo-only", experimental, etc. executable,
//                 it may diverge from Hashvive's coding style.
//
// It is part of the libhashvivekernel project.
