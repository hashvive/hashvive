...
{
    BOOST_CHECK(TestSplitHost("www.hashvive.org", "www.hashvive.org", 0));
    BOOST_CHECK(TestSplitHost("[www.hashvive.org]", "www.hashvive.org", 0));
    BOOST_CHECK(TestSplitHost("www.hashvive.org:80", "www.hashvive.org", 80));
    BOOST_CHECK(TestSplitHost("[www.hashvive.org]:80", "www.hashvive.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.hashvive.org:65536", "www.hashvive.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.hashvive.org:0", "www.hashvive.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.hashvive.org:", "www.hashvive.org:", 0, false));
}
