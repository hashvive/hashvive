...
#ifndef HASHVIVE_TEST_SCRIPTNUM10_H
#define HASHVIVE_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Hashvive 0.10.0, for cross-comparison.
 */
public:
...
#endif // HASHVIVE_TEST_SCRIPTNUM10_H
