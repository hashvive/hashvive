// Copyright (c) 2015-present The Hashvive developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef HASHVIVE_TEST_UTIL_SETUP_COMMON_H
#define HASHVIVE_TEST_UTIL_SETUP_COMMON_H
...
struct BasicTestingSetup {
     ...
     * test environments.
     *
     * @see https://github.com/hashvive/hashvive/issues/25055 for additional context.
     */
    ArgsManager m_args;
};
...
#endif // HASHVIVE_TEST_UTIL_SETUP_COMMON_H
