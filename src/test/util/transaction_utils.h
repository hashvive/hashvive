// Copyright (c) 2019-2020 The Hashvive developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef HASHVIVE_TEST_UTIL_TRANSACTION_UTILS_H
#define HASHVIVE_TEST_UTIL_TRANSACTION_UTILS_H
...
#endif // HASHVIVE_TEST_UTIL_TRANSACTION_UTILS_H
