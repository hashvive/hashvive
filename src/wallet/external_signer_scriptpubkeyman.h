// Copyright (c) 2019-2021 The Hashvive developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef HASHVIVE_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define HASHVIVE_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // HASHVIVE_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
