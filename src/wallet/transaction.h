...
#ifndef HASHVIVE_WALLET_TRANSACTION_H
#define HASHVIVE_WALLET_TRANSACTION_H
...
public:
     ...
     * on this hashvive node, and set to 0 for transactions that were created
...
#endif // HASHVIVE_WALLET_TRANSACTION_H
