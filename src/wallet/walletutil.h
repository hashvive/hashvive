// Copyright (c) 2017-2021 The Hashvive developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef HASHVIVE_WALLET_WALLETUTIL_H
#define HASHVIVE_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! hashvive from opening the wallet, thinking it was newly created, and
...
#endif // HASHVIVE_WALLET_WALLETUTIL_H
