...
#ifndef HASHVIVE_WALLET_SCRIPTPUBKEYMAN_H
#define HASHVIVE_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Hashvive wallet was originally a collection of unrelated private
...
#endif // HASHVIVE_WALLET_SCRIPTPUBKEYMAN_H
