...
#ifndef HASHVIVE_WALLET_WALLET_H
#define HASHVIVE_WALLET_WALLET_H
...
public:
     ...
     * hashvive-wallet tool code or by wallet migration code. If this is called
...
#endif // HASHVIVE_WALLET_WALLET_H
