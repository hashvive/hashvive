...
namespace init {
namespace {
const char* EXE_NAME = "hashvive-gui";
...
public:
    ...
    // hashvive-gui accepts -ipcbind option even though it does not use it
    // directly. It just returns true here to accept the option because
    // hashvive-node accepts the option, and hashvive-gui accepts all hashvive-node
