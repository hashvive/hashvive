...
#ifndef HASHVIVE_POLICY_FEERATE_H
#define HASHVIVE_POLICY_FEERATE_H
...
const std::string CURRENCY_UNIT = "HRLV"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    HRLV_KVB,      //!< Use HRLV/kvB fee rate unit
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::HRLV_KVB) const;
...
#endif // HASHVIVE_POLICY_FEERATE_H
