...
#ifndef HASHVIVE_IPC_CAPNP_COMMON_TYPES_H
#define HASHVIVE_IPC_CAPNP_COMMON_TYPES_H
...
//! needed to pass transaction objects between hashvive processes.
...
//! Functions to serialize / deserialize common hashvive types.
namespace mp {
...
#endif // HASHVIVE_IPC_CAPNP_COMMON_TYPES_H
