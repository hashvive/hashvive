...
# Extract options
function __fish_hashvive_tx_get_options
...
# Extract commands
function __fish_hashvive_tx_get_commands
...
complete \
    --command hashvive-tx \
    --condition "not __fish_hashvive_seen_cmd (__fish_hashvive_tx_get_commands --commandsonly)" \
    --arguments "(__fish_hashvive_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command hashvive-tx \
    --arguments "(__fish_hashvive_tx_get_commands)" \
    --no-files
