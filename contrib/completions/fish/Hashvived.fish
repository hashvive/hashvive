...
complete --command hashvived --no-files

# Extract options
function __fish_hashvived_get_options
...
complete \
    --command hashvived \
    --arguments "(__fish_hashvived_get_options --nofiles)"
