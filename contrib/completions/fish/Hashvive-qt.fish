...
complete --command hashvive-qt --no-files

# Extract options
function __fish_hashviveqt_get_options
...
complete \
    --command hashvive-qt \
    --arguments "(__fish_hashviveqt_get_options --nofiles)"
