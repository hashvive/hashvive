...
"""Example logging Hashvive utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/hashvived
...
def main(pid):
    ...
    # to the tracepoints
    hashvived_with_usdts.enable_probe(
        probe="flush", fn_name="trace_flush")
    b = BPF(text=program, usdt_contexts=[hashvived_with_usdts])
