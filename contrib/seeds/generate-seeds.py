...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef HASHVIVE_CHAINPARAMSSEEDS_H\n')
    g.write('#define HASHVIVE_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the hashvive network\n')
    ...
    g.write('#endif // HASHVIVE_CHAINPARAMSSEEDS_H\n')
