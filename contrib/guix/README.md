...
This directory contains the files necessary to perform bootstrappable hashvive
Core builds.
...
To build Hashvive reproducibly with all default options, invoke the
...
```
env DETACHED_SIGS_REPO=<path/to/hashvive-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/hashvive-core/guix.sigs).
