...
(define* (make-hashvive-cross-toolchain target
                                       #:key
...
desirable for building Hashvive release binaries."
...
;; failure; see https://github.com/hashvive/hashvive/pull/27296.
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list bison
                 ...
                 (make-hashvive-cross-toolchain target)))
